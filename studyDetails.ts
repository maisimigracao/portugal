...
,
  ...
  { type: 'title', content: 'Trabalhos Citados' },
  { type: 'list', content: [
    '1. The unemployment rate stood at 6.7% in the 4th quarter of 2024 and at 6.4% in 2024 - Statistics Portugal',
    '2. The unemployment rate remained at 6.1% - Statistics Portugal',
    '3. Portal do INE',
    '4. taxa de desemprego - Portal do INE',
    '5. Consulte as estatísticas da população, emprego e desemprego para o segundo trimestre de 2025 | BPstat - Banco de Portugal',
    '6. Taxa de desemprego entre imigrantes é o dobro da média nacional - DN',
    '7. Trabalhadores estrangeiros enfrentam mais desemprego e ganham menos - Jornal Económico',
    '8. Number of foreigners in Portugal doubles',
    '9. Número de estrangeiros em Portugal duplicou em 10 anos - Diário do Minho',
    '10. Imigrantes ocupam setores com carência de trabalhadores e enfrentam maior precariedade',
    '11. Imigrantes em Portugal ocupam setores com escassez de mão-de-obra, mas enfrentam maior precariedade - RHmagazine',
    '12. Escassez de mão-de-obra em Portugal | 2024 - Análises e Notas - GEP',
    '13. Há mais de 20 mil vagas de emprego que ninguém quer - ZAP Notícias',
    '14. Vagas: 19 mil empregos que ninguém quer - TVI Notícias',
    '15. Pesquisa - Iefponline',
    '16. Trabalhadores estrangeiros em Portugal — Instituto +Liberdade',
    '17. Imigrantes sustentam boa parte do crescimento econômico de Portugal',
    '18. Metade dos restaurantes tem falta de trabalhadores e maioria quer contratar estrangeiros',
    '19. Inquéritos - Magazine de Negócios AHRESP',
    '20. Estudos da AHRESP apontam para redução do negócio e desmotivação dos trabalhadores - Diário de Aveiro',
    '21. Construção, hotelaria e agricultura pedem mais mão de obra estrangeira - Idealista',
    '22. Anuário do Sector Agroalimentar de Portugal 2024 - CAP',
    '23. 70 mil portugueses emigraram em 2023, aponta relatório. Maioria são homens - DN',
    '24. Em 2023, emigraram 70 mil portugueses, na sua maioria, homens - sinalAberto',
    '25. OEm nos média - Observatório da Emigração',
    '26. Portugal perde nove mil milhões de euros com a fuga de cérebros',
    '27. Equidade na Educação - OCDE',
    '28. População portuguesa e imigração - Instituto +Liberdade',
    '29. Relatório de Migrações e Asilo 2023 - AIMA',
    '30. Contribuições de imigrantes para Segurança Social portuguesa aumentam para recorde de 1200 milhões de euros - Observador',
    '31. O Impacto Positivo dos Imigrantes na Segurança Social de Portugal',
    '32. Crescimento da Segurança Social em 2024 foi graças aos trabalhadores imigrantes',
    '33. Imigrantes impulsionam crescimento da Segurança Social em Portugal - Euro Dicas',
    '34. Estudo mostra que imigrantes aliviam pressão sobre impostos em Portugal - Euro Dicas'
  ]},
